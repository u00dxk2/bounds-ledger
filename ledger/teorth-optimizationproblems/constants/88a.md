...
- **Reading the table.**  Rows are in chronological order, not in order of strength, so the last row is not the record.  The record is $H\_1 \le 186$ [OAI26], of 30 August 2026; the two $240$ rows on either side of it are independent proofs of the previous record, deposited on 28 and 31 August.  Three of the four came within four days of each other and none cites the others.
