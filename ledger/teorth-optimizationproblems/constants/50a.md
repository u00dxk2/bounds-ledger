...
$$C_{50} = \sup_f \min_G
\frac{\mathbb{E}[ \operatorname{tr}(H_G f(G))]}{\lambda_{\max}(H_G)} \,.$$
...
| ----- | --------- | -------- |
| $< 1$ | [P25] | There exists $\alpha<1$, such that it is NP-hard to compute a value approximating QMC to within approximation ratio $\alpha$. |
