...
| $2$ | [Jin2026] | Jin: independent claimed proof of Crouzeix's conjecture, posted on preprints.org in July 2026 (very slightly before [LS2026]). |
| $2$ | [LS2026] | Lorist–Schwenninger: independent claimed proof of Crouzeix's conjecture, combining previous tools for weaker estimates with a "simple perturbation lemma for 2-dilations" applied to the iterates $f^n$ in the double-layer potential representation. |
...
- Crouzeix conjectured (in [C2004]) that $C_{2}=2$.  The lower bound $2$ matches the upper bounds of the two independent 2026 proofs [Jin2026] and [LS2026], so **the conjecture is (claimed to be) settled**: $C_{2} = 2$.  Both preprints appeared within a month of each other and are, to the authors' knowledge, independent.
