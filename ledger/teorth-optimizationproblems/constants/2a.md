...
| $1+\sqrt{2} \approx 2.41421$ | [CP2017] | Best universal upper bound prior to [LS2026]. Also holds in the completely bounded setting. |
| $2$ | [LS2026] | Lorist–Schwenninger: claimed proof of Crouzeix's conjecture, combining previous tools for weaker estimates with a "simple perturbation lemma for 2-dilations" applied to the iterates $f^n$ in the double-layer potential representation.  Matches the trivial lower bound, so $C_2 = 2$. |
...
- Crouzeix conjectured (in [C2004]) that $C_{2}=2$.  The lower bound $2$ matches the upper bound of [LS2026], so **the conjecture is (claimed to be) settled**: $C_{2} = 2$.
