...
| $3.879$ | <a href="#Lin2026">[Lin2026]</a> | Comparison with an explicit kernel for the Cauchy generator $A=-\lvert D\_u\rvert-\lvert D\_v\rvert$. In the diamond radius $r=\lvert u\rvert+\lvert v\rvert$, the kernel $K=(R/r-1)\_+/(R-1)-\varepsilon(1-r)\_+^2$ with $R=3797/2000$ and $\varepsilon=159411/200000$ satisfies $K\ge 1$ on the unit diamond and $AK\ge 0$ away from the origin, which gives $c\_2\le 3.879$. Formalized in Lean 4 as `CenteredMaximal.weakTypeConstant_two_le_upper`. |
...
- **Reading the tables.**  Rows are in chronological order, not in order of strength, so the last row is not always the record.  The current records are the $\Phipprox 1.6855099933$ lower bound and the $3.879$ upper bound, both [Lin2026]; among the earlier lower bounds, [Ald2000]'s $pprox 1.6211915$ is stronger than the [Mel2003] row that follows it.
...
- <a id="Lin2026"></a>**[Lin2026]** Lin, Yongxi. *Bounds 1.6855 and 3.879 for the planar centred Hardy-Littlewood maximal constant over squares.* Lean 4 formalization, [GitHub](https://github.com/CoolRmal/centered-maximal-constant) at commit `8e1ee3d`, registered on the Palomar registry as [PALOMAR-2026-09-19-000002](https://palomar-registry.org/entry?id=PALOMAR-2026-09-19-000002&version=2) (2026).
